...
type ApproveImplementationParams struct {
	CcID                         string
	CurrentState                 string
...
func (q *Queries) ApproveImplementation(ctx context.Context, arg ApproveImplementationParams) (ChangeControl, error) {
	row := q.db.QueryRowContext(ctx, approveImplementation,
		arg.CcID,
		arg.CurrentState,
		arg.ImplementationApprovalStatus,
		arg.Decision,
		arg.RiskLevel,
		arg.DecisionComments,
		arg.ImplementationApprovalByID,
		arg.ImplementationApprovalOn,
		arg.LastUpdatedByID,
	)
	var i ChangeControl
	err := row.Scan(
...
const cancelChangeControl = `-- name: CancelChangeControl :one
UPDATE change_controls
SET current_state = $2,
    implementation_approval_status = $3,
...
type CancelChangeControlParams struct {
	CcID                         string
	CurrentState                 string
	ImplementationApprovalStatus string
...
func (q *Queries) CancelChangeControl(ctx context.Context, arg CancelChangeControlParams) (ChangeControl, error) {
	row := q.db.QueryRowContext(ctx, cancelChangeControl,
		arg.CcID,
		arg.CurrentState,
		arg.ImplementationApprovalStatus,
...
type GetChangeControlByCcIDRow struct {
	...
	EvidenceFileSize    *int64
	EvidenceContentType *string
	EvidenceUploadedOn  *time.Time
}
...
type RejectImplementationParams struct {
	CcID                         string
	CurrentState                 string
	ImplementationApprovalStatus string
	Decision                     *string
...
func (q *Queries) RejectImplementation(ctx context.Context, arg RejectImplementationParams) (ChangeControl, error) {
	row := q.db.QueryRowContext(ctx, rejectImplementation,
		arg.CcID,
		arg.CurrentState,
		arg.ImplementationApprovalStatus,
		arg.Decision,
...
const submitForFinalApproval = `-- name: SubmitForFinalApproval :one
UPDATE change_controls
SET current_state = $2,
...
type SubmitForFinalApprovalParams struct {
	CcID                string
	CurrentState        string
	FinalApprovalStatus string
	LastUpdatedByID     uuid.UUID
...
func (q *Queries) SubmitForFinalApproval(ctx context.Context, arg SubmitForFinalApprovalParams) (ChangeControl, error) {
	row := q.db.QueryRowContext(ctx, submitForFinalApproval,
		arg.CcID,
		arg.CurrentState,
		arg.FinalApprovalStatus,
		arg.LastUpdatedByID,
...
const updateImplementationDetails = `-- name: UpdateImplementationDetails :one
UPDATE change_controls
SET
    -- Implementation Details (BRD 29–33)
    actual_implementation_date = $1,
    post_implementation_issues = $2,
    implementation_summary     = $3,
    deviations_from_plan       = $4,
    validation_performed       = $5,
...
type UpdateImplementationDetailsParams struct {
...
func (q *Queries) UpdateImplementationDetails(ctx context.Context, arg UpdateImplementationDetailsParams) (ChangeControl, error) {
	row := q.db.QueryRowContext(ctx, updateImplementationDetails,
		arg.ActualImplementationDate,
		arg.PostImplementationIssues,
		arg.ImplementationSummary,
		arg.DeviationsFromPlan,
		arg.ValidationPerformed,
		arg.LastUpdatedByID,
		arg.CcID,
	)
	var i ChangeControl
